...
public class setvaluesilii002a {
    public static void main (String argv[]) {
        ArgumentHandler argHandler = new ArgumentHandler(argv);
        Log log = new Log(System.err, argHandler);
        IOPipe pipe = argHandler.createDebugeeIOPipe(log);
        setvaluesilii002aClassToCheck classToCheck = new setvaluesilii002aClassToCheck();
...
class setvaluesilii002aClassToCheck {
    ...
    static float   f1S[] = {0,
                            Float.NEGATIVE_INFINITY, Float.MIN_VALUE, -1, -0, 0,
    ...
    static byte    b1S[] = {0, 1,
                            ...
                            Byte.MIN_VALUE, -1, 0, 1, Byte.MAX_VALUE,
                            Byte.MIN_VALUE, -1};
    static int     i1S[] = {0, 1, 2,
                            Integer.MIN_VALUE, -1, 0, 1, Integer.MAX_VALUE,
                            Integer.MIN_VALUE, -1, 0, 1, Integer.MAX_VALUE, -1};
    static long    l1S[] = {0, 1, 2, 3,
                            Long.MIN_VALUE, -1, 0, 1, Long.MAX_VALUE,
                            Long.MIN_VALUE, -1, 0, 1, Long.MAX_VALUE};
    static short   r1S[] = {0, 1, 2, 3, 4,
                            Short.MIN_VALUE, -1, 0, 1, Short.MAX_VALUE,
                            Short.MIN_VALUE, -1, 0, 1};
    static char    c1S[] = {0, 1, 2, 3, 4, 5,
                            Character.MIN_VALUE, '\u00ff', '\uff00', '\u1234',
                            '\u4321', '\ufedc', '\ucdef', Character.MAX_VALUE};
    static boolean z1S[] = {false, false, false, false, false, false, false,
