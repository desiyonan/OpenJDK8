...
public class defaultArguments001 {
    ...
    public static int run(String argv[],PrintStream out) {
        ...
        for (int i = 1; aci.hasNext(); i++) {
            ...
            if (cdfltArgmnts == null) {
                log.complain("FAILURE: connector with empty default "
                           + "arguments map is found!:");
                log.complain("         Name: " + c.name());
                return 2;
            }
            log.display("Next (" + i + ") connector's arguments is: "
                        + cdfltArgmnts);
        };
