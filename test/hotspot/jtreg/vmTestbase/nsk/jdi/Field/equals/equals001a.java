...
public class equals001a {
    public static void main (String argv[]) {
        ...
        ClassToCheck check = new ClassToCheck();
...
class ClassToCheck {
    ...
    // Methods
    void    v_m() {}
    boolean z_m() { return true;      }
    byte    b_m() { return (byte)1;   }
    char    c_m() { return (char)1;   }
    double  d_m() { return (double)1; }
    float   f_m() { return (float)1;  }
    int     i_m() { return (int)1;    }
    long    l_m() { return (long)1;   }
}
