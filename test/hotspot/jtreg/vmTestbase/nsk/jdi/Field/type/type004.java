...
public class type004 {
    ...
    private final static String className = "type004";
    ...
    private static void check (String fieldName) {
        try {
            ...
            for (int i = 0; i < expectedEnumFieldsNames.length; i++) {
                 ...
                 if (foundField != null) {
                     if (foundField.type().equals(checkedClass)) {
                         ...
                         complain("\t of unexpected type " + foundField.type().name());
                         exitStatus = Consts.TEST_FAILED;
                     }
                 } else {
