...
public class isvisible001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadisvisible001a.lockingObject) {
                             synchronized (Threadisvisible001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadisvisible001a.waitnotifyObj.wait();
...
class Threadisvisible001a extends Thread {
    ...
    void log(String str) {
        isvisible001a.log2("thread2: " + str);
    }
