...
/**
 * This class is used as debuggee application for the linenumber_s001 JDI test.
 */
public class linenumber_s001a {
...
class TestClass {     // minLine
    ...
    static final int minLine = 122;
    static final int maxLine = 146;
