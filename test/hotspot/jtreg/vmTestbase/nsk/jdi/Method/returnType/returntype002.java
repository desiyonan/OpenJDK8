 ...
 *    class returntype002aTestClass {                   <BR>
 *        public void vd () { return ; }                <BR>
 *   }                                                  <BR>
 *                                                      <BR>
 * for the above void method vd,                        <BR>
 * a debugger forms its corresponding Type object.      <BR>
 * <BR>
 */

public class returntype002 {
    ...
    sHeader2 = "--> returntype002: ",
    sHeader3 = "##> returntype002: ";
    ...
    public static int run (String argv[], PrintStream out) {
        return new returntype002().runThis(argv, out);
    }
    ...
    private int runThis (String argv[], PrintStream out) {
        ...
        log2("returntype002a debuggee launched");
        debuggee.resume();
    ...
    //------------------------------------------------------  testing section
        ...
        pipe.println("newcheck");
           ...
           List listOfDebuggeeClasses = vm.classesByName(mName + ".returntype002aTestClass");
            ...
            for (i2 = 0; ; i2++) {
                ...
                case 0:                 // void
                        ...
                        try {
                            VoidType vdType = (VoidType) m.returnType();
                        } catch ( ClassCastException e1 ) {
                            log3("ERROR: CCE: (VoidType) m.returnType();");
                            expresult = 1;
                            break;
                        } catch ( ClassNotLoadedException e2 ) {
                            log3("ERROR: CNLE: (VoidType) m.returnType();");
                            expresult = 1;
                            break;
                        }
                        break;
