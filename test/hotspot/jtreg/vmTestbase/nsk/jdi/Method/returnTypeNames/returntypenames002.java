 ...
 *    class returntypenames002aTestClass {              <BR>
 *        public void vd () { return ; }                <BR>
 *   }                                                  <BR>
 *                                                      <BR>
 * for the above void method vd, a debugger forms       <BR>
 * text representation of return type as void.          <BR>
 * <BR>
 */

public class returntypenames002 {
    ...
    sHeader2 = "--> returntypenames002: ",
    sHeader3 = "##> returntypenames002: ";
    ...
    public static int run (String argv[], PrintStream out) {
        return new returntypenames002().runThis(argv, out);
    }
    ...
    private int runThis (String argv[], PrintStream out) {
        ...
        log2("returntypenames002a debuggee launched");
        debuggee.resume();
    ...
    //------------------------------------------------------  testing section
        ...
        pipe.println("newcheck");
           ...
           List listOfDebuggeeClasses = vm.classesByName(mName + ".returntypenames002aTestClass");
