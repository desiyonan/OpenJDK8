 ...
 *   - restricts the MethodEntryRequest1 to the tread1 and
 *     to the array elements #0 & #0 calling only within thread1,
 *   - restricts the MethodEntryRequest2 to the thread2 and
...
public class instancefilter004 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.MethodEntryRequest.addInstanceFilter.instancefilter004a";
        return new instancefilter004().runThis(argv, out);
    }

    private String testedClassName =
      "nsk.jdi.MethodEntryRequest.addInstanceFilter.instancefilter004aTestClass";
    ...
    protected void testRun() {
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
                ...
                ((MethodEntryRequest) eventRequest1).addInstanceFilter(instance1);
                ((MethodEntryRequest) eventRequest1).addInstanceFilter(instance1);
                ((MethodEntryRequest) eventRequest2).addInstanceFilter(instance1);
                ((MethodEntryRequest) eventRequest2).addInstanceFilter(instance2);

                display("......waiting for MethodEntryEvent in expected thread");
                MethodEntryEvent newEvent = (MethodEntryEvent)eventHandler.waitForRequestedEvent(new EventRequest[]{eventRequest1, eventRequest2}, waitTime, true);
