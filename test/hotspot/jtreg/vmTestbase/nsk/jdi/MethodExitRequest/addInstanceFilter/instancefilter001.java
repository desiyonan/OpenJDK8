 ...
 *     thus restricting the MethodExit event only for thread1,
...
public class instancefilter001 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.MethodExitRequest.addInstanceFilter.instancefilter001a";
        return new instancefilter001().runThis(argv, out);
    }

    private String testedClassName =
      "nsk.jdi.MethodExitRequest.addInstanceFilter.instancefilter001aTestClass";
    ...
    protected void testRun() {
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
                ...
                ((MethodExitRequest) eventRequest2).addInstanceFilter(instance);
