 ...
 * <li>any threads started during the single threaded invocation
 * will not be suspended when the invocation completes.<p>
 *
 * A debuggee part of the test starts several threads. The debugger
 * calls the JDI method with the flag
 * <i>ObjectReference.INVOKE_SINGLE_THREADED</i>.
