 ...
 * <code>com.sun.jdi.PrimitiveValue.charValue()</code>          <BR>
 ...
 *                                                      <BR>
 *      pvbl1.charValue() == 1                          <BR>
 *      pvbl0.charValue() == 0                          <BR>
 *      pvbt1.charValue() == (char) Byte.MAX_VALUE      <BR>
 *      pvbt0.charValue() == 0                          <BR>
 *      pvch1.charValue() == Character.MAX_VALUE        <BR>
 *      pvch0.charValue() == 0                          <BR>
 *<BR>
 *<BR>
 *      pvfl1.charValue() == (char) Float.MAX_VALUE     <BR>
 *      pvfl0.charValue() == 0                          <BR>
 *      pvin1.charValue() == (char) Integer.MAX_VALUE   <BR>
 *      pvin0.charValue() == 0                          <BR>
 *      pvln1.charValue() == (char) Long.MAX_VALUE      <BR>
 *      pvln0.charValue() == 0                          <BR>
 *      pvsh1.charValue() == (char) Short.MAX_VALUE     <BR>
 *      pvsh0.charValue() == 0                          <BR>
 * <BR>
 */

public class charvalue001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new charvalue001().runThis(argv, out);
    }
    ...
    private int runThis (String argv[], PrintStream out) {
        ...
        log2("charvalue001a debuggee launched");
        debuggee.resume();
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            for (i2 = 0; ; i2++) {
                ...
                case 0:
                        log2("......checks for: pvbl1.charValue() == 1   and  pvbl0.charValue() != 0");
                        if (pvbl1.charValue() != 1 || pvbl0.charValue() != 0) {
                            log3("ERROR: pvbl1.charValue() != 1 || pvbl0.charValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 1:
                        log2("......checks for: pvbt1.charValue() != (char) Byte.MAX_VALUE  and  pvbt0.charValue() != 0");
                        if (pvbt1.charValue() != (char) Byte.MAX_VALUE || pvbt0.charValue() != 0) {
                            log3("ERROR: pvbt1.charValue() != (char) Byte.MAX_VALUE || pvbt0.charValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 2:
                        log2("......checks for: pvch1.charValue() != Character.MAX_VALUE  and  pvch0.charValue() != 0");
                        if (pvch1.charValue() != Character.MAX_VALUE || pvch0.charValue() != 0) {
                            log3("ERROR: pvch1.charValue() != Character.MAX_VALUE || pvch0.charValue() != 0");
                            expresult = 1;
                        }
                        break;
                ...
                case 4:
                        log2("......checks for: pvfl1.charValue() != (char) Float.MAX_VALUE  and  pvfl0.charValue() !=0");
                        if (pvfl1.charValue() != (char) Float.MAX_VALUE || pvfl0.charValue() !=0 ) {
                            log3("ERROR: pvfl1.charValue() != (char) Float.MAX_VALUE || pvfl0.charValue() !=0");
                            expresult = 1;
                        }
                        break;

                case 5:
                        log2("......checks for: pvin1.charValue() != (char) Integer.MAX_VALUE  and  pvin0.charValue() != 0");
                        if (pvin1.charValue() != (char) Integer.MAX_VALUE || pvin0.charValue() != 0) {
                            log3("ERROR: pvin1.charValue() != (char) Integer.MAX_VALUE || pvin0.charValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 6:
                        log2("......checks for: pvln1.charValue() != (char) Long.MAX_VALUE  and  pvln0.charValue() != 0");
                        if (pvln1.charValue() != (char) Long.MAX_VALUE || pvln0.charValue() != 0) {
                            log3("ERROR: pvln1.charValue() != (char) Long.MAX_VALUE || pvln0.charValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 7:
                        log2("......checks for: pvsh1.charValue() != (char) Short.MAX_VALUE  and  pvsh0.charValue() != 0");
                        if (pvsh1.charValue() != (char) Short.MAX_VALUE || pvsh0.charValue() != 0) {
                            log3("ERROR: pvsh1.charValue() != (char) Short.MAX_VALUE || pvsh0.charValue() != 0");
                            expresult = 1;
                        }
                        break;
