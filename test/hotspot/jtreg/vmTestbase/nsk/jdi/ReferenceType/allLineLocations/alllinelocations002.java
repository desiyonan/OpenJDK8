 ...
 * <code>com.sun.jdi.ReferenceType.allLineLocations()</code>
...
public class alllinelocations002 {
    ...
    public static int run(String argv[], PrintStream out) {
        return new alllinelocations002().runIt(argv, out);
    }
    ...
    private int runIt(String args[], PrintStream out) {
        ...
        vm = debuggee.VM();
        debuggee.redirectStderr(log, "alllinelocations002t.err> ");
        debuggee.resume();
        ...
        try {
            ...
            for (int i=0; i<FLD_NUM; i++) {
                ...
                try {
                    ...
                    List locs = testedType.allLineLocations();
                    if (locs.size() == 0)
