 ...
 */
public class alllinelocations002t {
    ...
    public static int run(String args[]) {
        ...
        pipe.println(alllinelocations002.COMMAND_READY);
        String cmd = pipe.readln();
        if (cmd.equals(alllinelocations002.COMMAND_QUIT)) {
            System.err.println("Debuggee: exiting due to the command: "
                + cmd);
            return Consts.TEST_PASSED;
        }

        int stopMeHere = 0; // alllinelocations002.DEBUGGEE_STOPATLINE
    ...
    static alllinelocations002tDummyIf dummyIf =
        new alllinelocations002tDummyCls();
}

class alllinelocations002tDummyCls
    implements alllinelocations002tDummyIf {}

interface alllinelocations002tDummyIf {}
