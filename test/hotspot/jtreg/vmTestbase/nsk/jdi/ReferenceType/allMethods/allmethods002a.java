...
//        package_prefix = "";    //  for DEBUG without package
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> allmethods002a: FAILED!");
 ...
 */
class allmethods002aClassLoader extends ClassLoader {

    private String classPath;
    public static Class loadedClass;

    public allmethods002aClassLoader(String classPath, String className) {
        super(allmethods002aClassLoader.class.getClassLoader());
