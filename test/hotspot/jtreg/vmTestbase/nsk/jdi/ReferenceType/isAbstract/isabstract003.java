...
public class isabstract003 {
    ...
    private final static String prefix = "nsk.jdi.ReferenceType.isAbstract.";
    private final static String className = "isabstract003";
    private final static String debuggerName = prefix + className;
    private final static String debuggeeName = debuggerName + "a";

    //------------------------------------------------------- test specific fields

    private final static String[] testedFieldNames = {"f1"};
    ...
    private static void check (String fieldName) {
        try {
            ...
            if (checkedClass.isEnum()) {
                display("ReferenceType.isAbstract() returned expected true for type: " + className);
            } else {
                complain("ReferenceType.isAbstract() returned unexpected false for type: " + className);
                exitStatus = Consts.TEST_FAILED;
            }
