...
public class isabstract003a {
    ...
    static isabstract003Enum f1 = isabstract003Enum.e1;
    ...
    public static void main (String argv[]) {
        ...
        pipe.println(isabstract003.SIGNAL_READY);
        receiveSignal(isabstract003.SIGNAL_QUIT);
