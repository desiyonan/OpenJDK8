...
public class isfinal002 {
    ...
    private final static String prefix = "nsk.jdi.ReferenceType.isFinal.";
    ...
    private static void check (String fieldName) {
        try {
            ...
            if (checkedClass.isFinal()) {
                display("ReferenceType.isFinal() returned true for " + className);
            } else {
                complain("ReferenceType.isFinal() returned false for " + className);
                exitStatus = Consts.TEST_FAILED;
            }
