 ...
 * <code>com.sun.jdi.ReferenceType.locationsOfLine(String,String,int)</code>
 ...
 * an interface type.
 */
public class locationsofline_ssi002 {
    ...
    private int runIt(String args[], PrintStream out) {
        ...
        vm = debuggee.VM();
        debuggee.redirectStderr(log, "locationsofline_ssi002t.err> ");
        debuggee.resume();
            ...
            for (int i=0; i<FLD_NUM; i++) {
                ...
                for (int j=0; j<2; j++) {
                    ...
                    try {
                        ...
                        switch(j) {
                        case 0:
                            locs = testedType.locationsOfLine(
                                null, null, 1);
                            break;
                        case 1:
                            locs = testedType.locationsOfLine(
                                vm.getDefaultStratum(), null, 1);
                            break;
                        }
                        if (locs.size() == 0)
