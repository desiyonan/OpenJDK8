 ...
 */
public class locationsofline_ssi002t {
    ...
    public static int run(String args[]) {
        ...
        pipe.println(locationsofline_ssi002.COMMAND_READY);
        String cmd = pipe.readln();
        if (cmd.equals(locationsofline_ssi002.COMMAND_QUIT)) {
            System.err.println("Debuggee: exiting due to the command: "
                + cmd);
            return Consts.TEST_PASSED;
        }

        int stopMeHere = 0; // locationsofline_ssi002.DEBUGGEE_STOPATLINE
    ...
    static locationsofline_ssi002tDummyIf dummyIf =
        new locationsofline_ssi002tDummyCls();
}

class locationsofline_ssi002tDummyCls
    implements locationsofline_ssi002tDummyIf {}

interface locationsofline_ssi002tDummyIf {}
