...
//                ("**> methods001a: load class: Throwable thrown = " + thrown.toString());
        ...
        System.err.println("!!**> methods001a: FAILED!");
        System.exit(2/*STATUS_FAILED*/ + 95/*STATUS_TEMP*/);
    }
}

abstract class methods001aClassForCheck extends methods001aSuperClassForCheck
    implements methods001aInterfaceForCheck {
...
abstract class methods001aSuperClassForCheck  {
...
interface methods001aInterfaceForCheck {
