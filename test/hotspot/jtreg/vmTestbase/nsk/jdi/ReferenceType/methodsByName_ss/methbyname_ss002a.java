...
//        package_prefix = "";    //  for DEBUG without package
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> methbyname_ss002a: FAILED!");
 ...
 */
class methbyname_ss002aClassLoader extends ClassLoader {

    private String classPath;
    public static Class loadedClass;

    public methbyname_ss002aClassLoader(String classPath, String className) {
        super(methbyname_ss002aClassLoader.class.getClassLoader());
