 ...
 *    gets a Map containing LocalVariable objects, mirroring            <BR>
 *    method variables in the runt2(), which becomes invalid            <BR>
 *    when runt2() is resumed and runt1() is suspended.                 <BR>
 *    After getting the thread2 suspended second time,                  <BR>
 *    the debugger extracts a List of LocalVariables from               <BR>
 *    the Map and checks up that the method invocation                  <BR>
 *    StackFrame.getValues() on the List argument does throw            <BR>
...
public class getvalues002 {
    ...
    private String testedClassName =
        "nsk.jdi.StackFrame.getValues.Threadgetvalues002a";
    ...
    private int runThis (String argv[], PrintStream out) {
        ...
        log2("getvalues002a debuggee launched");
        debuggee.resume();
    ...
    //------------------------------------------------------  testing section
        ...
        pipe.println("newcheck");
            ...
            label1: {
                ...
                log2("     getting current StackFrame object at first breakpoint");
                try {
                ...
                log2("     getting List of LocalVariables for checking up");
                try {
                ...
                log2("      checking up that the List of testedVars is not valid for current StackFrame");
                try {
                    Map returnedVars  = stackFrame.getValues(testedVars);

                    log3("ERROR:  no IllegalArgumentException after exit from runt2()");
                    expresult = returnCode1;
                } catch ( IllegalArgumentException eIllegal ) {
                    log2("     :  IllegalArgumentException after exit from runt2()");
                }
            }
