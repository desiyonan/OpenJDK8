...
public class setvalue004a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadsetvalue004a.lockingObject) {
                             synchronized (Threadsetvalue004a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadsetvalue004a.waitnotifyObj.wait();
...
class Threadsetvalue004a extends Thread {
    ...
    public Threadsetvalue004a(String threadName) {
        super(threadName);
    }
