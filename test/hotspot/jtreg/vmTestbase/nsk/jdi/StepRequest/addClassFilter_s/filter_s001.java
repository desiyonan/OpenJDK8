 ...
 * <code>com.sun.jdi.StepRequest.addClassFilter()</code>
...
public class filter_s001 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.StepRequest.addClassFilter_s.filter_s001a";
        return new filter_s001().runThis(argv, out);
    }

    private String testedClassName1 = "TestClass11";
    private String testedClassName2 = "nsk.jdi.StepRequest.addClassFilter_s.Thread2filter_s001a";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
                ...
                if ( !(newEvent instanceof StepEvent)) {
                    ...
                    String str = ((StepEvent)newEvent).location().declaringType().name();
                    if (!str.endsWith(testedClassName1)) {
                        setFailedStatus("Received StepEvent for unexpected class: \n\t" + str);
                    } else {
                        display("Received StepEvent for expected class: \n\t" + str);
                    }
                ...
                if ( !(newEvent instanceof StepEvent)) {
                    ...
                    String str = ((StepEvent)newEvent).location().declaringType().name();
                    if (!(str.indexOf(testedClassName2) == 0)) {
                        setFailedStatus("Received StepEvent for unexpected class: \n\t" + str);
                    } else {
                        display("Received StepEvent for expected class: \n\t" + str);
                    }
