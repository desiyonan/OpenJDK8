...
class TestClass10{
    static void m10() {
        thread001a.log1("entered: m10");
    }
}
class TestClass11 extends TestClass10{
    static void m11() {
        thread001a.log1("entered: m11");
        TestClass10.m10();
    }
}
...
class Thread1thread001a extends Thread {
    ...
    public void run() {
        ...
        synchronized(thread001a.waitnotifyObj) {
            thread001a.waitnotifyObj.notify();
        }
        synchronized(thread001a.lockObj) {
            TestClass11.m11();
        }
