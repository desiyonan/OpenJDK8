...
/**
 * This class is used as debuggee application for the frames_ii002 JDI test.
 */

public class frames_ii002a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadframes_ii002a.lockingObject) {
                             synchronized (Threadframes_ii002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadframes_ii002a.waitnotifyObj.wait();
...
class Threadframes_ii002a extends Thread {

    public Threadframes_ii002a(String threadName) {
        super(threadName);
    }
...
*/
    ...
    void log(String str) {
        frames_ii002a.log2("thread2: " + str);
    }
