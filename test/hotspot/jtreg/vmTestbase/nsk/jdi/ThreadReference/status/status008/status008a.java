...
public class status008a {
    ...
    static String testedThreadName = "unStartedThread";
    static Thread unStartedThread;
    ...
    public static void main (String argv[]) {
        ...
        unStartedThread = new Thread(testedThreadName);

        pipe.println(status008.SIGNAL_READY);
        receiveSignal(status008.SIGNAL_QUIT);
