...
public class ispublic001a {
    ...
    public boolean zP0, zP1[] = {zP0}, zP2[][] = {zP1};
    public byte    bP0, bP1[] = {bP0}, bP2[][] = {bP1};
    public char    cP0, cP1[] = {cP0}, cP2[][] = {cP1};
    public double  dP0, dP1[] = {dP0}, dP2[][] = {dP1};
    public float   fP0, fP1[] = {fP0}, fP2[][] = {fP1};
    public int     iP0, iP1[] = {iP0}, iP2[][] = {iP1};
    public long    lP0, lP1[] = {lP0}, lP2[][] = {lP1};
    public short   rP0, rP1[] = {rP0}, rP2[][] = {rP1};
    ...
    public Boolean   ZP0, ZP1[] = {ZP0}, ZP2[][] = {ZP1};
    public Byte      BP0, BP1[] = {BP0}, BP2[][] = {BP1};
    public Character CP0, CP1[] = {CP0}, CP2[][] = {CP1};
    public Double    DP0, DP1[] = {DP0}, DP2[][] = {DP1};
    public Float     FP0, FP1[] = {FP0}, FP2[][] = {FP1};
    public Integer   IP0, IP1[] = {IP0}, IP2[][] = {IP1};
    public Long      LP0, LP1[] = {LP0}, LP2[][] = {LP1};
    public Short     RP0, RP1[] = {RP0}, RP2[][] = {RP1};

    String    s0, s1[] = {s0}, s2[][] = {s1};
    Object    o0, o1[] = {o0}, o2[][] = {o1};
    public String S0, S1[] = {S0}, S2[][] = {S1};
    public Object O0, O1[] = {O0}, O2[][] = {O1};
    ...
    public static void main (String argv[]) {
        ...
        ispublic001a ispublic001a_ = new ispublic001a();
