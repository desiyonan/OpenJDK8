...
public class isstatic004 {
    ...
    private final static String className = "isstatic004";
            ...
            for (int i = 0; i < expectedEnumFieldsNames.length; i++) {
                 ...
                 if (foundField != null) {
                     if (foundField.isStatic()) {
                         display("enum " + className + " has static field " + expectedEnumFieldsNames[i]);
                         display("\t of type " + className);
                     } else {
                         complain("enum " + className + " has instance field " + expectedEnumFieldsNames[i]);
