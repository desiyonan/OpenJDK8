...
/**
 * This class is used as a debugee application for the mirrorof_bool001 JDI test.
 */

public class mirrorof_bool001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> mirrorof_bool001a: " + message);
    }
