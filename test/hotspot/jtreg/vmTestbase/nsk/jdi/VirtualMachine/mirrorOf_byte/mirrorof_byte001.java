 ...
 * <code>com.sun.jdi.VirtualMachine.mirrorOf(byte value)</code> <BR>
 * complies with the spec for                                   <BR>
 * <code>com.sun.jdi.ByteValue</code> methods                   <BR>
 * <BR>
 * The cases for testing are as follows <BR>
 * ('val_i' means 'byte_value_i') :     <BR>
 *                                      <BR>
 * // ByteValue val.value() method      <BR>
 *                                                      <BR>
 *      val_i.value(Byte.MIN_VALUE)  == Byte.MIN_VALUE  <BR>
 *      val_i.value(Byte.MAX_VALUE)  == Byte.MAX_VALUE  <BR>
 *      val_i.value(0)     ==  0                        <BR>
 *      val_i.value(-1)    == -1                        <BR>
 *      val_i.value(+1)    == +1                        <BR>
 *                                                      <BR>
 * // ByteValue val.equals() method                     <BR>
 *                                                      <BR>
 ...
 *                                                      <BR>
 * // ByteValue val.hashCode() method                   <BR>
 *                                                      <BR>
...
public class mirrorof_byte001 {
    ...
    sHeader2 = "--> mirrorof_byte001: ",
    sHeader3 = "##> mirrorof_byte001: ";
    ...
    public static int run (String argv[], PrintStream out) {
        return new mirrorof_byte001().runThis(argv, out);
    }
    ...
    private int runThis (String argv[], PrintStream out) {
        ...
        log2("mirrorof_byte001a debugee launched");
        debugee.resume();
    ...
    //------------------------------------------------------  testing section
        ...
        byte smallest   =  Byte.MIN_VALUE;
        byte zero       =  0;
        byte largest    =  Byte.MAX_VALUE;
        byte plus1      =  +1;
        byte minus1     =  -1;

        ByteValue val_1 = vm.mirrorOf(smallest);
        ByteValue val_2 = vm.mirrorOf(zero);
        ByteValue val_3 = vm.mirrorOf(largest);
        ByteValue val_4 = vm.mirrorOf(plus1);
        ByteValue val_5 = vm.mirrorOf(plus1);
        ByteValue val_6 = vm.mirrorOf(minus1);

        ShortValue val_7 = vm.mirrorOf((short)plus1);
