...
/**
 * This class is used as debugee application for the mirrorof_char001a JDI test.
 */

public class mirrorof_char001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> mirrorof_char001a: " + message);
    }
