...
/**
 * This class is used as debugee application for the mirrorof_float001a JDI test.
 */

public class mirrorof_float001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> mirrorof_float001a: " + message);
    }
