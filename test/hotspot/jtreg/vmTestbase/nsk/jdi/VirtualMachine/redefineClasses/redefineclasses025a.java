...
/**
 *  <code>redefineclasses025a</code> is deugee's part of the redefineclasses025.
 */
public class redefineclasses025a {
    ...
    public static void main (String argv[]) {
        ...
        if (instr.equals("load_class")) {
            ...
            redefineclasses025c.classPrepare = true;
        } else {
...
abstract class redefineclasses025c implements redefineclasses025b {
