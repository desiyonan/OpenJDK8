 ...
 *     within the method in the class instancefilter002aTestClass
 ...
 *     thus restricting the Modification event only for thread1,
...
public class instancefilter002 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.WatchpointRequest.addInstanceFilter.instancefilter002a";
        return new instancefilter002().runThis(argv, out);
    }

    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addInstanceFilter.instancefilter002aTestClass";
