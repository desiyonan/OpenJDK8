 ...
 */
public class classfloadhk007 extends DebugeeClass {

    /** Load native library if required. */
    static {
        System.loadLibrary("classfloadhk007");
    }
    ...
    public static int run(String argv[], PrintStream out) {
        return new classfloadhk007().runIt(argv, out);
    }
    ...
    public static final String TESTED_CLASS_NAME = PACKAGE_NAME + ".classfloadhk007r";
    ...
    /* custom classloader to load tested class */
    public static classfloadhk007ClassLoader classLoader = null;
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        classLoader = new classfloadhk007ClassLoader(origPath);
...
class classfloadhk007ClassLoader extends ClassLoader {
    private String path;

    /** Make classloader providing path to class files. */
    public classfloadhk007ClassLoader(String path) {
        this.path = path;
    }
