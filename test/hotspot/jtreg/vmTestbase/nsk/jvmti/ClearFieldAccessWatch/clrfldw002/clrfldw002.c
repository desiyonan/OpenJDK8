...
Java_nsk_jvmti_ClearFieldAccessWatch_clrfldw002_check(JNIEnv *env, jclass cls) {
    ...
    if (!caps.can_generate_field_access_events) {
        err = (*jvmti)->ClearFieldAccessWatch(jvmti, cls, fid1);
        ...
        err = (*jvmti)->ClearFieldAccessWatch(jvmti, NULL, fid2);
        ...
        err = (*jvmti)->ClearFieldAccessWatch(jvmti, cls, NULL);
        ...
        err = (*jvmti)->ClearFieldAccessWatch(jvmti, cls, fid2);
