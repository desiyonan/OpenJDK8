...
Java_nsk_jvmti_ClearFieldModificationWatch_clrfmodw002_check(JNIEnv *env,
    ...
    if (!caps.can_generate_field_modification_events) {
        ...
        err = (*jvmti)->ClearFieldModificationWatch(jvmti, cls, fid1);
        ...
        err = (*jvmti)->ClearFieldModificationWatch(jvmti, NULL, fid2);
        ...
        err = (*jvmti)->ClearFieldModificationWatch(jvmti, cls, NULL);
        ...
        err = (*jvmti)->ClearFieldModificationWatch(jvmti, cls, fid2);
