...
Java_nsk_jvmti_GetFieldModifiers_getfldmdf003_check(JNIEnv *env, jclass cls) {
    ...
    err = (*jvmti)->GetFieldModifiers(jvmti, NULL, fid, &modifiers);
    ...
    err = (*jvmti)->GetFieldModifiers(jvmti, cls, NULL, &modifiers);
    ...
    err = (*jvmti)->GetFieldModifiers(jvmti, cls, fid, NULL);
