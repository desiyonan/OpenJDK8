...
void checkMeth(jvmtiEnv *jvmti_env, JNIEnv *env, jclass cl,
    ...
    err = (*jvmti_env)->GetMethodName(jvmti_env, mid,
    ...
    (*jvmti_env)->Deallocate(jvmti_env, (unsigned char*) ret_name);
    (*jvmti_env)->Deallocate(jvmti_env, (unsigned char*) ret_sig);
}
