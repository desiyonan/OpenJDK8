...
public class gettag001 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new gettag001().runIt(argv, out);
    }
    ...
    // tested thread
    public static gettag001TestedClass testedObject = null;
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        testedObject = new gettag001TestedClass();
