...
public class thrcputime002 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new thrcputime002().runIt(argv, out);
    }
    ...
    static final String TESTED_THREAD_NAME = "thrcputime002Thread";
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thrcputime002Thread thread = new thrcputime002Thread(TESTED_THREAD_NAME, iterations);
...
class thrcputime002Thread extends Thread {
    ...
    public thrcputime002Thread(String name, int iterations) {
        super(name);
