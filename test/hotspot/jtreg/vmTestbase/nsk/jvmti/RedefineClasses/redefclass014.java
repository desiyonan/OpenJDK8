...
public class redefclass014 {
    ...
    static {
        try {
            System.loadLibrary("redefclass014");
        } catch (UnsatisfiedLinkError ule) {
            System.err.println("Could not load redefclass014 library");
    ...
    public static int run(String args[], PrintStream out) {
        ...
        String fileName = fileDir + File.separator + "newclass" + File.separator +
            redefclass014.class.getName().replace('.', File.separatorChar) +
            ".klass";
        try {
