...
public class redefclass022 {
    ...
    static {
        try {
            System.loadLibrary("redefclass022");
        } catch (UnsatisfiedLinkError ule) {
            System.err.println("Could not load redefclass022 library");
    ...
    public static int run(String args[], PrintStream out) {
        ...
        String fileName = fileDir + File.separator + "newclass" + File.separator +
            redefclass022a.class.getName().replace('.', File.separatorChar) +
            ".class";
        try {
        ...
        redefclass022a tc = new redefclass022a();
