...
static char *CALLBACK_CLASS_NAME = "nsk.jvmti.RetransformClasses.retransform003";

/* Classes, belonging to the package defined in the TRIGGER variable will be retransformed */
static char *TRIGGER = "nsk/share/jvmti/RetransformClasses"; //
