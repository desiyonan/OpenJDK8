...
Java_nsk_jvmti_SetLocalVariable_setlocal002_check(JNIEnv *env, jclass cls, jthread thr) {
    ...
    for (i = 0; i < entryCount; i++) {
        if (strcmp(table[i].name, "o") == 0) {
            err = (*jvmti)->SetLocalObject(jvmti, cls, 1,
            ...
            err = (*jvmti)->SetLocalInt(jvmti, cls, 1,
                table[i].slot, (jint)0);
            if (err != JVMTI_ERROR_INVALID_THREAD) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_INVALID_THREAD,\n");
            ...
            err = (*jvmti)->SetLocalLong(jvmti, cls, 1,
            ...
            err = (*jvmti)->SetLocalFloat(jvmti, cls, 1,
            ...
            err = (*jvmti)->SetLocalDouble(jvmti, cls, 1,
    ...
    for (i = 0; i < entryCount; i++) {
        if (strcmp(table[i].name, "o") == 0) {
            err = (*jvmti)->SetLocalObject(jvmti, thr, -1,
                table[i].slot, (jobject)cls);
            ...
            err = (*jvmti)->SetLocalInt(jvmti, thr, -1,
                table[i].slot, (jint)0);
            if (err != JVMTI_ERROR_ILLEGAL_ARGUMENT) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_INVALID_FRAMEID,\n");
            ...
            err = (*jvmti)->SetLocalLong(jvmti, thr, -1,
                table[i].slot, (jlong)0);
            if (err != JVMTI_ERROR_ILLEGAL_ARGUMENT) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_INVALID_FRAMEID,\n");
            ...
            err = (*jvmti)->SetLocalFloat(jvmti, thr, -1,
                table[i].slot, (jfloat)0);
            if (err != JVMTI_ERROR_ILLEGAL_ARGUMENT) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_INVALID_FRAMEID,\n");
            ...
            err = (*jvmti)->SetLocalDouble(jvmti, thr, -1,
                table[i].slot, (jdouble)0);
            if (err != JVMTI_ERROR_ILLEGAL_ARGUMENT) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_INVALID_FRAMEID,\n");
    ...
    for (i = 0; i < entryCount; i++) {
        if (strcmp(table[i].name, "o") == 0) {
            err = (*jvmti)->SetLocalObject(jvmti, thr, 0,
                table[i].slot, (jobject)cls);
            ...
            err = (*jvmti)->SetLocalInt(jvmti, thr, 0,
                table[i].slot, (jint)0);
            if (err != JVMTI_ERROR_OPAQUE_FRAME) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_OPAQUE_FRAME,\n");
            ...
            err = (*jvmti)->SetLocalLong(jvmti, thr, 0,
                table[i].slot, (jlong)0);
            if (err != JVMTI_ERROR_OPAQUE_FRAME) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_OPAQUE_FRAME,\n");
            ...
            err = (*jvmti)->SetLocalFloat(jvmti, thr, 0,
                table[i].slot, (jfloat)0);
            if (err != JVMTI_ERROR_OPAQUE_FRAME) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_OPAQUE_FRAME,\n");
            ...
            err = (*jvmti)->SetLocalDouble(jvmti, thr, 0,
                table[i].slot, (jdouble)0);
            if (err != JVMTI_ERROR_OPAQUE_FRAME) {
                printf("(%s) ", table[i].name);
                printf("Error expected: JVMTI_ERROR_OPAQUE_FRAME,\n");
