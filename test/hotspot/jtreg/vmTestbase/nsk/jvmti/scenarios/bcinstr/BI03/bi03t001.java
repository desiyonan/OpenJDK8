...
public class bi03t001 extends DebugeeClass {

    static final int MAGIC_NUMBER = 101;
    static final String bi03t001aClassName =
        "nsk.jvmti.scenarios.bcinstr.BI03.bi03t001a";
    ...
    public static int run(String argv[], PrintStream out) {
        return new bi03t001().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        String fileNameA = fileDir + File.separator + "newclass" + File.separator +
            bi03t001aClassName.replace('.', File.separatorChar) + ".class";
        ...
        log.display("redefining bi03t001a class via ClassFileLoadHook event");
        bi03t001a testedClass = new bi03t001a();
