...
public class bi03t002 extends DebugeeClass {

    static final int MAGIC_NUMBER = 101;
    static final String bi03t002aClassName =
        "nsk.jvmti.scenarios.bcinstr.BI03.bi03t002a";
    ...
    public static int run(String argv[], PrintStream out) {
        return new bi03t002().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        String fileNameA = fileDir + File.separator + "newclass" + File.separator +
            bi03t002aClassName.replace('.', File.separatorChar) + ".class";
        ...
        bi03t002a testedClass = new bi03t002a();
        ...
        log.display("redefining bi03t002a class via RedefineClasses function");
