...
public class em02t012 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new em02t012().runIt(argv, out);
    }

    /* =================================================================== */

    static final int STEP_NUMBER = 3;
    static final int DEPTH = 1000;
    ...
    void javaMethod() {
        ...
        if (currentDepth < DEPTH) {
            ...
            logger.display("depth is reached");
            checkStatus(Consts.TEST_PASSED);

        }
    }

    native void setThread(Thread thrd);
}
