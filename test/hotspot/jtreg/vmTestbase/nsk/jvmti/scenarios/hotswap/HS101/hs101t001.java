...
public class hs101t001 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new hs101t001().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new hs101t001Thread("Debuggee Thread", EXPECTED.length);
...
class hs101t001Thread extends Thread {
    ...
    public hs101t001Thread(String name, int n) {
        super(name);
        numbers = new long[n];
    }
