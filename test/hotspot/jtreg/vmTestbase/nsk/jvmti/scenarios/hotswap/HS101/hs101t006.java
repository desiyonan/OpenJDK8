...
public class hs101t006 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new hs101t006().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new hs101t006Thread("Debuggee Thread", MAX_LENGTH);
...
class hs101t006Thread extends Thread {
    ...
    public hs101t006Thread(String name, int n) {
        super(name);
        numbers = new long[n];
    }
