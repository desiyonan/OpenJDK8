...
public class hs102t001 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new hs102t001().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new hs102t001Thread("Debuggee Thread", PATTERN[0]);
...
class hs102t001Thread extends Thread {
    ...
    public hs102t001Thread(String name, String s) {
        super(name);
