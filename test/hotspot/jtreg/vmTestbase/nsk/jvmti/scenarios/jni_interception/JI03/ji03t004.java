 ...
 * restore original function and verify that original function works.</code>
 * <br>
 ...
 */
public class ji03t004 {
    ji03t004a _ji03t004a = new ji03t004a();

    static {
        try {
            System.loadLibrary("ji03t004");
        } catch (UnsatisfiedLinkError ule) {
            System.err.println("Could not load \"ji03t004\" library");
    ...
    public static int run(String args[], PrintStream out) {
        return new ji03t004().runIt(args, out);
    }
...
/**
 * Tested class used for allocation
 */
class ji03t004a {}
